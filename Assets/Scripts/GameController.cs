...
public class GameController : MonoBehaviour
{
    ...
    {
        // 这里可以根据玩家的选择从PlayerPrefs或者其他存储方式获取选择的玩家类型
        // 例如，假设我们用整数0, 1, 2来表示选择的玩家
        int selectedPlayerType = PlayerPrefs.GetInt("SelectedPlayer", 0);
        ...
        // 在场景中实例化玩家预制体
        return Instantiate(selectedPlayer, new Vector3(0, 0, 0), Quaternion.identity);
    }
